...
export const studentPaths: Record<string, any> = {
          ...
          'application/json': {
            schema: {
              ...
              properties: {
                id: { 
                  type: 'string',
                  description: 'Unique student identifier (e.g., student ID number)'
                },
                name: { 
                  type: 'string',
  ...
  '/students/{studentId}': {
    ...
    patch: {
      ...
      description: 'Updates the name of a specific student belonging to the authenticated teacher.',
      security: [{ bearerAuth: [] }],
      parameters: [
        {
          name: 'studentId',
